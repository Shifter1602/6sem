...
// Pytnashki Shablon.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPytnashkiShablonApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CPytnashkiShablonApp::OnAppAbout)
...
// создание CPytnashkiShablonApp

CPytnashkiShablonApp::CPytnashkiShablonApp()
{
	...
	SetAppID(_T("Pytnashki Shablon.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CPytnashkiShablonApp

CPytnashkiShablonApp theApp;


// инициализация CPytnashkiShablonApp

BOOL CPytnashkiShablonApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CPytnashkiShablonDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CPytnashkiShablonView));
	if (!pDocTemplate)
		return FALSE;
...
int CPytnashkiShablonApp::ExitInstance()
{
...
// обработчики сообщений CPytnashkiShablonApp
...
void CPytnashkiShablonApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
